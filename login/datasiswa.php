...
<script>
  $(document).ready(function() {
    ...
    $('#hapusSemuaBtn').on('click', function() {
      $.ajax({
        url: 'importdelete/hapusdatasiswa.php', // Ganti dengan URL yang sesuai ke file PHP yang akan menghapus data
        type: 'POST',
        data: {
          hapusSemua: true
...
<div class="datalatih">
  <div class="kepala">
    <div class="isikepala">
      <span><a href="">Home</a> / Data Siswa</span>
    </div>
  </div>
  <div class="konten">
    <div class="isi-konten">
      ...
      <div>
        <form method="POST" enctype="multipart/form-data" action="importdelete/importsiswa.php">
        ...
        <table id='example' class='display datatables_wrapper border' style='width:100%'>
          <thead>
            <tr>
              ...
              <th>Daya Listrik</th>
              <th class='tambahdata'>
                <div class='kotak'><a href='?p=tbhdatasiswa'>Tambah</a></div>
              </th>
            </tr>
          </thead>
          <tbody id="tableBody">
