<div class="hasilprediksi">
    <div class="konten">
        <div class="isi-konten">
            <div class="judul">
                <h3>Isikan Form Untuk Memprediksi Data Baru!</h3>
            </div>
            <form action="pro2-prediksi.php" method="post">
                <div class="label">
                ...
                <div class="label">
                    ...
                    <div class="kotak">
                        <select name="listrik" id="listrik">
                            ...
                            <option value="&ge;2200 VA">&ge;2200 VA</option>
                        </select>
                    </div>
                </div>
                <div class="btn">
                    ...
                    <div class="batal">
                        <a href="?p=hasilprediksi">Batal</a>
                    </div>
                </div>
