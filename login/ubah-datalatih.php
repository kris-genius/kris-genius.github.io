    ...
    <div class="konten">
        <div class="isi-konten">
            ...
            if (isset($_GET['idsiswa'])) {
                ...
                $sql = "SELECT * FROM datatraining WHERE idsiswa='$idsiswa'";
            ...
            ?>
                    <form action="simpan-editdl.php" method="POST">
                        <div class="label">
                        ...
                        <div class="label">
                            ...
                            <div class="kotak">
                                <select name="pembayaran" id="pembayaran">
                                    <option value=""></option>
                                    <option value="Lancar" <?php if ($row['pembayaran'] == 'Lancar') echo 'selected'; ?>>Lancar</option>
                                    <option value="Tidak Lancar" <?php if ($row['pembayaran'] == 'Tidak Lancar') echo 'selected'; ?>>Tidak Lancar</option>
                                </select>
                            </div>
                        </div>
